...
class AIService:
    ...
    def route_query(self, query: str, history: list = None) -> list:
        ...
        system_prompt = (
            ...
            "7. get_employee_summary(user_id='...') - Summary of ONE employee. 'user_id' can be an ID (ABC123) or a NAME (James Baker).\n"
            "8. get_employee_transcript(user_id='...') - Transcript of ONE employee. 'user_id' can be an ID (ABC123) or a NAME (James Baker).\n"
            "9. get_compliance_report(user_id='...') - Compliance for ONE employee. 'user_id' can be an ID (ABC123) or a NAME (James Baker).\n"
            ...
            "--- CRITICAL GUIDELINES ---\n"
            "- If a query is about a SPECIFIC person, use tools 7, 8, or 9. You can pass the name directly to 'user_id'.\n"
